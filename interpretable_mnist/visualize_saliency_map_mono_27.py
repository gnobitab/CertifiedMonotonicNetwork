...
def get_test_saliency_avg():
    for batch_idx, (x, target) in enumerate(test_loader):
        ...
        plt.savefig('./figs/mono/%d_img.png'%batch_idx)
        plt.cla()
        ...
        plt.savefig('./figs/mono/%d_pos_saliency.png'%batch_idx)
        plt.cla()
        
        plt.axis('off')
        plt.imshow(normalize(grad_map_neg), cmap='Blues', alpha=1.)
        plt.savefig('./figs/mono/%d_neg_saliency.png'%batch_idx)
        plt.cla()
        ...
        plt.savefig('./figs/mono/%d_img_modified.png'%batch_idx)
        plt.cla()
